...
export default function AccountPage({ user }: { user: User }) {
  return (
    <Editor>
      <div className='mt-10 px-6 2xl:w-[65%]'>
        <div className='overflow-hidden bg-white border border-gray-900/10 shadow-lg sm:rounded-lg mb-4 lg:m-8 dark:border-gray-100/10'>
          ...
          <div className='border-t border-gray-900/10 dark:border-gray-100/10 px-4 py-5 sm:p-0'>
            <dl className='sm:divide-y sm:divide-gray-900/10 sm:dark:divide-gray-100/10'>
              ...
              <div className='py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6'>
                ...
                <UserCurrentPaymentPlan subscriptionStatus={user.subscriptionStatus as SubscriptionStatus} subscriptionPlan={user.subscriptionPlan} datePaid={user.datePaid} credits={user.credits} />
              </div>
              <div className='py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6'>
                ...
                <dd className='mt-1 text-sm text-gray-900 dark:text-gray-400 sm:col-span-2 sm:mt-0'>
                  {user.credits > 100 ? "I'm a dedicated creator." : user.credits < 5 ? 'I need more credits.' : "I'm a cool customer."}
                </dd>
              </div>
            </dl>
          </div>
